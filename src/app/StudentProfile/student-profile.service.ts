...
import { mAwards, mCertificate, mCreateProfile, mEducationQualification, mExperience, mExpertise, mExtraCurriculam, mGallery, mInternship } from '../Pages/create-profile/m-create-profile.model';
...
export class StudentProfileService {
  ...
  getInternshipTable(){
    this.http.get(environment.apiKey + 'dtl_Internship/GetInternshipByRegId/2')
    .subscribe(
      res => {
